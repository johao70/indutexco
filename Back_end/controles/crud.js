...
let getDatosOrdenes = (req, res) => {
  db.raw(
    "select id, f_clientes(idclientes) as idclientes, fecha_orden from ordenes order by id desc"
  )
    .then((resultado) => {
      return res.status(200).json({
        ok: true,
